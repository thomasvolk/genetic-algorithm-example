...
public class CSVPassengerFactory extends AbstractPassengerFactory {

    @Override
    protected List<Passenger> lesePassagiere(InputStream is, int anzahl) throws IOException {
        List<Passenger> passagiere = new ArrayList<>();
